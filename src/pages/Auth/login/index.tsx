                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        placeholder="e.g. ●●●●●●●●"
                        type="password"
                        className="rounded-lg border-[0.1rem] border-zinc-400 bg-transparent py-2.5 pe-2.5 ps-4 outline-none placeholder:text-zinc-400 invalid:border-red-500 focus-visible:ring-0 focus:border-white"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
