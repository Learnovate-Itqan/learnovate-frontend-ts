...
export default function MentorsHeader() {
  return (
    <header className="relative flex justify-start items-center min-h-[calc(24rem-85px)] bg-gradient-to-br from-dark-navy via-dark-navy/90 text-white py-20">
      <div
        style={{ backgroundImage: `url(${MentorHeaderImage})` }}
      ...
      <main className="container flex flex-col justify-center items-start z-20">
        <h1 className="text-5xl font-semibold">Mentors</h1>
        <p className="text-lg mt-4">Connect with mentors who can guide you on your educational journey.</p>
      </main>
    </header>
  );
}
