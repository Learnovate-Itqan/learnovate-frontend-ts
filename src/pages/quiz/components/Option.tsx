...
export function Option({ option, value, onChange, checked }: OptionsProps) {
  return (
    <div className="flex justify-start items-center gap-3 cursor-pointer" onClick={() => onChange(value)}>
      <span
