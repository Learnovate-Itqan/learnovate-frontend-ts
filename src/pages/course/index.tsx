      ...
      <div className="">
        <main className="flex gap-6">
          <section className="grow">
            ...
            <section className="py-5 grid gap-8">
          ...
          <section className=" grid gap-5">
            <div className="shadow-custom w-96 rounded-xl overflow-hidden">
              <header className="px-5 py-8 rounded-xl shadow-custom">
                <div className="w-full flex flex-col gap-2">
                  ...
                  <Progress className="max-w-96 h-2 rounded-full bg-zinc-300" value={course?.progress * 100} />
                </div>
              </header>
            ...
            <div className="px-5 grid w-96 gap-3 py-5 text-dark-navy shadow-custom rounded-xl">
